...
<script src="${pageContext.request.contextPath}/resources/js/resultAllNews.js" type="text/javascript"></script>
...
<div id="page-wrapper" style="height:1000px;">
    <div style="position: absolute;
        left: 22%;">
    <%--<div id="toptotal">--%>
        <%--找到约 <span id="records">0</span> 条结果 <nobr>（用时 <span id="usedtime">0</span> 秒）</nobr>--%>
    <%--</div>--%>
    <ul id="result">
        <!--  <div>
             <div id="title"><h3>
